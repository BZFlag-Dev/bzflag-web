...
<ul>
  ...
  <li>BZFlag 2.4.x <strong>ONLY</strong> allows textures from images.bzflag.org. Some images that had been on various <em>username</em>.bzflag.bz hostnames have been migrated to <a href="http://images.bzflag.org/bz_legacy/">images.bzflag.org/bz_legacy/</a><em>username</em> to ease migration to 2.4.  Maps will need to be updated, however.</li>
</ul>
